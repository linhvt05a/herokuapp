...
const actions = {
    ...
    LOAD_FILTER_AREA_FAILURE: name + "LOAD_FILTER_AREA_FAILURE",

    // FILTER_BLOCK
    LOAD_FILTER_BLOCK: name + "LOAD_FILTER_BLOCK",
    LOAD_FILTER_BLOCK_SUCCESS: name + "LOAD_FILTER_BLOCK_SUCCESS",
    LOAD_FILTER_BLOCK_FAILURE: name + "LOAD_FILTER_BLOCK_FAILURE",
    ...
    LOAD_FILTER_PROJECT_STATUS_FAILURE: name + "LOAD_FILTER_PROJECT_STATUS_FAILURE",

    // FILTER_FLOOR
    LOAD_FILTER_FLOOR: name + "LOAD_FILTER_FLOOR",
    LOAD_FILTER_FLOOR_SUCCESS: name + "LOAD_FILTER_FLOOR_SUCCESS",
    LOAD_FILTER_FLOOR_FAILURE: name + "LOAD_FILTER_FLOOR_FAILURE",
    ...
    LOAD_FILTER_LIST_OPEN_SALE_FAILURE: name + "LOAD_FILTER_LIST_OPEN_SALE_FAILURE",
