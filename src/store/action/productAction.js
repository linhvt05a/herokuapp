...
const actions = {
    ...
    PRODUCT_MARK_LIST_REQUEST: 'PRODUCT_MARK_LIST_REQUEST',
    PRODUCT_MARK_LIST_FAILURE: 'PRODUCT_MARK_LIST_FAILURE',
    PRODUCT_MARK_LIST_SUCCESS: 'PRODUCT_MARK_LIST_SUCCESS',
    ...
    productMark: (params) => ({
        type: actions.PRODUCT_MARK_LIST_REQUEST,
        params: params
    }),
