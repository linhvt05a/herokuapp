...
export const DATA_TOTAL_REQUEST = 'DATA_TOTAL_REQUEST';
export const DATA_TOTAL_SUCCESS = 'DATA_TOTAL_SUCCESS';
export const DATA_TOTAL_FAILURE = 'DATA_TOTAL_FAILURE';