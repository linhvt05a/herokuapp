...
const AmountInformation = props => {
    return (
        <div className="borrow__item">
            <div className="borrow__title text-uppercase">THÔNG TIN SỐ TIỀN   <i className="sub"> Nhập số tiền của sản phẩm dự án, chúng tôi sẽ đề nghị khoản vay cho ban. </i>
            </div>
                ...
                <div className="row">
                    ...
                    <div className="col-12 col-sm-6 col-xl-4">
                        <div className="form-group mb-3 mb-xl-0">
                            ...
                            <input type="text" placeholder="-" defaultValue="500.000.000" readOnly className="form-control" />
                        </div>
                    </div>
                    <div className="col-12 col-sm-6 col-xl-4">
                        <div className="form-group mb-3 mb-xl-0">
                            ...
                            <input type="text" placeholder="-" defaultValue="2.500.000.000" readOnly className="form-control" />
                        </div>
                    </div>
                </div>
            </div>
