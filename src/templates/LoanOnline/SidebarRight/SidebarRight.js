        ...
        <div className="col-12 col-sm-12 col-lg-4">
            <div className="sales_box">
                <div className="sales_heading">
                    ...
                    <span className="number">{data ? convertFloatToString((data.amountBorrow * data.unitPay) + (data.amountBorrow * (data.interestIncentives * 100) * data.unitPay / 10000)) : '-----'}</span>
                </div>
                            ...
                            <div className="details__01">
                                <div className="chart-detail">
                                    <span className="status status01">
                                        Số tiền vay <b>{dataconvertFloatToString(data.amountBorrow * data.unitPay)}</b>
                                    </span>
