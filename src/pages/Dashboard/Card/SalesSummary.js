...
const SalesSummary = (props) => {
    ...
    const getPercent = () => {
        ...
        if (isGetDataTotalSuccess && dataTotalRes) {
            ...
            if (dataTotalRes.internal && dataTotalRes.internal.total_seller_all && dataTotalRes.internal.total_seller_join && dataTotalRes.internal.total_seller_all != 0) {
                channelPer = (dataTotalRes.internal.total_seller_join * 100) / dataTotalRes.internal.total_seller_all
            }
            if (dataTotalRes.total_product && dataTotalRes.total_product.total_product_all && dataTotalRes.total_product.total_product_open_sell && dataTotalRes.total_product.total_product_all != 0) {
                channelPer = (dataTotalRes.total_product.total_product_open_sell * 100) / dataTotalRes.total_product.total_product_all
            }
            if (dataTotalRes.total_project && dataTotalRes.total_project.total_project_all && dataTotalRes.total_project.total_project_sell_open && dataTotalRes.total_project.total_project_all != 0) {
                channelPer = (dataTotalRes.total_project.total_project_sell_open * 100) / dataTotalRes.total_project.total_project_all
            }
        }
        setState({
            ...state,
    ...
    const getArrow = () => {
        ...
        console.log("productArrow", isProductUp)
        setState({
            ...state,
    ...
    return (
        <div className="row sales_summary">
            {console.log("proArrow", state.isProductArrow)}
                ...
                <div className="sales_summary--item style_01 h-100">
                    ...
                    <div className="text">
                        ...
                        <div className="text-3">
                            <span style={{width: "100%"}} class="done"></span>
                        </div>
                        {
                            (dataTotalRes && dataTotalRes.channel && dataTotalRes.channel.total_channel_diff && dataTotalRes.channel.total_channel_diff != 0) &&
            ...
            <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 d-flex flex-column">
                <div className="sales_summary--item style_02 h-100">
                    ...
                    <div className="text">
                        ...
                        {
                            (dataTotalRes && dataTotalRes.internal && dataTotalRes.internal.total_seller_sale_diff && dataTotalRes.internal.total_seller_sale_diff != 0) &&
            ...
            <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 d-flex flex-column">
                <div className="sales_summary--item style_03 h-100">
                    ...
                    <div className="text">
                        ...
                        {
                            (dataTotalRes && dataTotalRes.total_project && dataTotalRes.total_project.total_project_diff && dataTotalRes.total_project.total_project_diff != 0) &&
            ...
            <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 d-flex flex-column">
                <div className="sales_summary--item style_04 h-100">
                    ...
                    <div className="text">
                        ...
                        {
                            (dataTotalRes && dataTotalRes.total_product && dataTotalRes.total_product.total_product_diff && dataTotalRes.total_product.total_product_diff != 0) &&
