...
import{DISTRIBUTION_CHANNEL_TYPE} from '../../../constant'
const selectAfter = (
 ...
 const DistributionChanel = (props) =>{
     if(props.distribute === 1){
        return <InputText className="col-12 col-sm-6 col-md-6 col-lg-4" label="Kênh phân phối" value={DISTRIBUTION_CHANNEL_TYPE[0].label} disabled/>
     }else{
        return <InputText className="col-12 col-sm-6 col-md-6 col-lg-4" label="Kênh phân phối" value={DISTRIBUTION_CHANNEL_TYPE[1].label} disabled/> 
     }
