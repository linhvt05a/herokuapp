                            ...
                            <table className="table table-sticky-01">
                                ...
                                <tr data-parent="row_720">
                                    ...
                                    <td className="col-2 text-right">
                                            ...
                                            <i className="active icon icon_toggle las la-plus-circle "></i>
                                        
                                    </td>
                                </tr>
                                
                                    <tr className="child-row_720">
                                        <td style={{width: `10%`}} className="col-1 pl-0  border-bottom-none "></td>
                                    ...
                                    <tr className="child-row_720">
                                        <td style={{width: `10%`}} className="col-1 pl-0 "></td>
                                        <td className="col-3 pl-0">
