...
const ProductSignInModal = (props) => {
    const {handleSignIn, handleChange, values,errors, closeModal} = props
  return (
            ...
            <div
              ...
              >
                <div
                  ...
                  style={{ width: 400 }}
                >
                <InputBase type="text" placeholder="Email" name="email" top={10} onChange ={handleChange} value={values.email} errors={errors.email}/>
                <InputBase type="password" placeholder="Password" top={10} name="password"  onChange={handleChange} value={values.password} errors={errors.password}/>
