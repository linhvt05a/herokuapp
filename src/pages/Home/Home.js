...
const news = [
  {
    ...
    description:
      "Quỹ đất nội thành ngày càng khan hiếm, cộng với quá trình rà soát lại khiến thịtrường bất động sản lớn nhất nước rơi vào tình trạng cung giảm",
...
const Home = (props) => {
  ...
  useEffect(() => {
    const updateWindowDimensions = () => {
      const newHeight = document.getElementsByClassName("header")[0]
        .clientHeight;
      setHeight(newHeight);
    };
  ...
  return (
    <div className="homePage" style={{ paddingTop: height }}>
            ...
            <div className="row">
              ...
              <div className="col-12 col-sm-12 col-md-12 col-xl-6 p-0">
                <figure
                  className="has_bg"
                  style={{
                    backgroundImage: "url(./assets/images/map_search.jpg)",
                  }}
                ></figure>
              </div>
            </div>
      ...
      <CardSaleFlash
        ...
        labelHeader="flash_sale"
        datas={["a", "iu", "e", "vl", "wa", "di"]}
        options={options}
        timeLine
      />
      {/* block over  */}
                ...
                <div className="item">
                  ...
                  <div className="heading">
                    ...
                    <p className="address mb-0">
                      227 đường Nguyễn Văn Cừ, Phường 4, Quận 7, Tp.HCM
                    </p>
                  </div>
                  <div className="details">
                    ...
                    <p className="child mb-0">
                      ...
                      <span className="text">
                        Giá cho thuê :{" "}
                        <i className="price">26 ( triệu/tháng )</i>
                      </span>
                    </p>
                  </div>
                </div>
              ...
              <div className="col-12 col-lg-6">
                <div className="app_managerment--left">
                  ...
                  <h5 className="sub-title">
                    Ứng dụng quản lý của chúng tôi với các tính năng nổi bật về
                    việc quản lý các thông tin bất động sản và kèm theo điều
                    khiển các thiết bị thông minh trong nhà như :
                  </h5>
                  <ul className="features">
                    <li>
                      <p className="name">Quản lý dự án</p>
                      <p className="des">
                        Xây dựng các công trình bất động sản chất lượng, đạt
                        chuẩn cao cấp và đáp ứng yêu cầu của bạn.
                      </p>
                    </li>
                    <li>
                      <p className="name">Quản lý dự án</p>
